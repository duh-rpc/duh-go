...
func (x *TestErrorsRequest) Reset() {
	*x = TestErrorsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_demo_demo_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *TestErrorsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TestErrorsRequest) ProtoMessage() {}

func (x *TestErrorsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_demo_demo_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TestErrorsRequest.ProtoReflect.Descriptor instead.
func (*TestErrorsRequest) Descriptor() ([]byte, []int) {
	return file_proto_demo_demo_proto_rawDescGZIP(), []int{4}
}

func (x *TestErrorsRequest) GetCase() string {
	if x != nil {
		return x.Case
	}
	return ""
...
var file_proto_demo_demo_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x67, 0x72, 0x61, 0x79, 0x22,
	0x27, 0x0a, 0x11, 0x54, 0x65, 0x73, 0x74, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x63, 0x61, 0x73, 0x65, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x04, 0x63, 0x61, 0x73, 0x65, 0x42, 0x25, 0x5a, 0x23, 0x67, 0x69, 0x74, 0x68,
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x68, 0x61, 0x62, 0x6f, 0x72, 0x2d, 0x70, 0x6b, 0x67,
	0x2f, 0x64, 0x75, 0x68, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x64, 0x65, 0x6d, 0x6f, 0x62,
...
var file_proto_demo_demo_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_proto_demo_demo_proto_goTypes = []interface{}{
	...
	(*TestErrorsRequest)(nil),   // 4: duh.v1.TestErrorsRequest
}
...
func file_proto_demo_demo_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_demo_demo_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TestErrorsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
